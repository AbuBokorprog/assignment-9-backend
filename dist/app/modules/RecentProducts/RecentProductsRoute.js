...
router.post('/', (0, Auth_1.default)(client_1.UserRole.CUSTOMER), (0, ValidationRequest_1.default)(RecentProducts_validation_1.recentProductsValidation.createRecentValidation), RecentProductsController_1.recentProductsController.createRecentProducts);
router.get('/', RecentProductsController_1.recentProductsController.retrieveAllRecentProducts);
router.get('/user/my-recent-products', (0, Auth_1.default)(client_1.UserRole.CUSTOMER), RecentProductsController_1.recentProductsController.retrieveMyAllRecentProducts);
