...
const PaymentUtils = (user, transactionId) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const response = yield axios_1.default.post('https://sandbox.aamarpay.com/jsonpost.php', {
            ...
            success_url: `https://bazaar-bridge.vercel.app/api/payment/success-payment?transactionId=${transactionId}`,
            fail_url: 'https://bazaar-bridge.vercel.app/api/payment/failed-payment',
            cancel_url: 'https://bazaar-bridge-front.vercel.app/',
