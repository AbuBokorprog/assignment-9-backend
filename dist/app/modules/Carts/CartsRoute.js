...
router.post('/conflict/replace-cart', (0, Auth_1.default)(client_1.UserRole.CUSTOMER), (0, ValidationRequest_1.default)(CartsValidation_1.cartValidation.createCart), CartsController_1.cartsController.replaceCart);
