...
router.post('/', (0, Auth_1.default)(client_1.UserRole.CUSTOMER, client_1.UserRole.ADMIN, client_1.UserRole.SUPER_ADMIN, client_1.UserRole.SUPER_ADMIN), (0, ValidationRequest_1.default)(ComparisonValidation_1.comparisonValidation.createComparison), ComparisonController_1.comparisonController.createComparison);
...
router.delete('/:id', (0, Auth_1.default)(client_1.UserRole.CUSTOMER, client_1.UserRole.ADMIN, client_1.UserRole.SUPER_ADMIN, client_1.UserRole.SUPER_ADMIN), ComparisonController_1.comparisonController.deleteComparisonById);
